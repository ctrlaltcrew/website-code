        ...
        <main className="container mx-auto px-4 sm:px-6 lg:px-12 py-20">
          <article className="max-w-4xl mx-auto">
            ...
            <div className="mb-8 animate-slide-up">
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 font-mono">
                {post.title}
              </h1>

              <div className="flex flex-wrap items-center gap-4 text-sm sm:text-base text-muted-foreground mb-8">
            ...
            {relatedPosts.length > 0 && (
              <div className="mt-16 pt-8 border-t border-border">
                <h2 className="text-xl sm:text-2xl font-bold mb-6 font-mono">Related Posts</h2>
                  ...
                  {relatedPosts.map((relatedPost) => (
                    ...
                    >
                      <article className="bg-card rounded-lg overflow-hidden border border-border hover:border-primary transition-all duration-300">
                        ...
                        <div className="p-4">
                          <h3 className="text-sm sm:text-base font-bold group-hover:text-primary transition-colors">
                            {relatedPost.title}
                          </h3>
                        </div>
                      </article>
